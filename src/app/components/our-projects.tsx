...
function OurProjects() {
  return (
    <section id='Portfolio' className='flex flex-col justify-center items-center px-8 py-28 gap-12 md:gap-20 bg-gradient-to-b from-second to-white px-[20px] md:px-[64px]'>
        ...
        <div data-aos="fade-up" className='w-1/2 md:w-1/4 mx-auto'>
          <MainButton className='w-full' >Get in Touch</MainButton>
        </div>
    </section>
  )
}
