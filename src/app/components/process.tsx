...
export default function Process() {
  ...
  return (
    <section id='Process' className='text-center lg:text-left px-[20px] md:px-[64px] py-[64px] bg-second md:bg-none md:bg-second' >
        <div className='relative flex flex-col lg:flex-row gap-[80px] justify-between'>
            {/* text content */}
            ...
            <div className='lg:hidden' data-aos="fade-up">
              <MainButton className='w-1/2 mx-auto   py-2 px-6' >Get in Touch</MainButton>
            </div>
